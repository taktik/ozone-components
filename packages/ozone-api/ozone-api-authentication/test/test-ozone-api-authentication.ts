import { OzoneApiAuthentication, getOzoneApiAuthentication } from '../src/index'
import { expect, assert } from 'chai'
import { OzoneConfig } from './ozone-dummy-config'
...
describe('ozone-api-authentication', function() {
	...
	describe('ozoneConnect (login)', function() {
		it('should return resolve promise on connection succeed', function(done) {
			...
			const api = getOzoneApiAuthentication(OzoneConfig.config)
